...
const loadNPause = async function (){
  try{
    const imageResolvedValue = await createImage();
    const waitForResolvedValue = await waitFor(imageResolvedValue);
    console.log(waitForResolvedValue)
...
// loadNPause();
const loadAllProm = async function (){
  try{
